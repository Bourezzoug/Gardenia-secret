...
<header style="background-image: url('{{ asset('images/background.jpeg') }}')" class="relative overflow-hidden">
    ...
    <nav class="container mx-auto p-5 flex items-center justify-between relative">
        ...
        <div class="nav-links transition-all hidden text-sm md:flex flex-col absolute top-20 md:top-0 left-0 md:left-0 md:flex-row justify-end md:static bg-white md:bg-transparent w-full font-openSans uppercase z-50">
            <a class="nav-link active mx-2 md:my-0 my-4 md:text-left text-center" aria-current="page" href="/">Home</a>
            ...
            <a class="nav-link active mx-2 md:my-0 my-4 md:text-left text-center" aria-current="page" href="{{ Route('boxPage.index') }}">Box du mois</a>

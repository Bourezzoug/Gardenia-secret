<div class="flex bg-white">
    ...
    <div wire:init="loadItems" class="w-full flex flex-col lg:pl-[250px]">
...
<div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
    <div class="flex items-center px-2 py-4">
      ...
      <div class="col-span-3 md:col-span-2 lg:col-span-1 mr-3">
        <x-label class="text-xs" for="select" value="{{ __('SortBy Position') }}"/>
    ...
    <tbody class="divide-y divide-gray-100 border-t border-gray-100">
        ...
        <td class="px-6 py-4 text-gray-900">
            {{ $banniere->nb_unique_vues }}
        </td>
        <td class="px-6 py-4 text-gray-900">
            {{ $banniere->nb_unique_click }}
        </td>
        <td class="px-6  py-4">

...
<header style="background-image: url('{{ asset('images/background.jpeg') }}')" class="relative overflow-hidden">
    <div class="absolute -right-96 top-0 h-full w-96 bg-black z-[999] social-media transition-all">
    ...
    <section id="hero" >
        <div class="heroSection owl-carousel owl-theme">
            <div class="container mx-auto p-5 flex flex-col md:flex-row text-center md:text-left justify-evenly items-center md:items-start">
                <div class="horizontal max-w-lg md:ml-20 md:my-0 md:py-10">
                    <h1 class="mb-3 mt-3 text-4xl leading-snug uppercase font-light">Votre <span class="text-main-color">Mystere  Box Beauté</span> <br> qui  vous rend heureuse</h1>
                    <p class="mb-6 text-sm text-gray-500">Découvrez nos produits personnalisés, partagez votre expérience avec la communauté. Essayez, évaluez, testez et achetez vos préférés sur notre boutique en ligne.</p>
                    
                    <button class="hover:scale-110 transition-transform"><a href="{{ route('formulaire') }}" class="bg-main-color text-white px-5 py-3 rounded ">JE LA VEUX</a></button>
                </div>
                <div class="img mx-auto hidden md:block">
                    <img src="{{ asset('images/box.png') }}" class="xl:w-100 xl:h-100" alt="">
                </div>
            </div>
            <div class="container mx-auto p-5 flex flex-col md:flex-row text-center md:text-left   justify-evenly ">
                <div class="horizontal max-w-lg md:ml-20 md:my-0 md:py-10">
                    <h1 class="mb-3 mt-3 text-4xl leading-snug uppercase font-light">Votre <span class="text-main-color">Mystere  Box Beauté</span> <br> qui  vous rend heureuse</h1>
                    <p class="mb-6 text-sm text-gray-500">Découvrez nos produits personnalisés, partagez votre expérience avec la communauté. Essayez, évaluez, testez et achetez vos préférés sur notre boutique en ligne.</p>
                ...
                <div class="img mx-auto hidden md:block">
                    <img src="{{ asset('images/box-beaute.png') }}" class="w-100 h-100" alt="">
                </div>
            </div>
        </div>
...
<div class=" px-6 py-10 ">
    <div class="container mx-auto flex items-center justify-center flex-col concept">
        <h2 class="text-2xl sm:text-3xl md:text-header my-8 font-Lato uppercase relative w-full text-center z-10">Le Concept</h2>
        <p class="text-center max-w-3xl leading-loose text-lg font-cormorant">Faites-vous plaisir en vous laissant surprendre ou en surprenant vos proches en recevant chaque mois une sélection de produits de soin, de maquillage, d'accessoires et de gourmandises en format Full Size, soigneusement choisis par nos soins et livrés dans une jolie boîte. Et découvrez les dernières nouveautés et tendances avec nous.</p>
    </div>
</div>

<section class="bg-background-color py-10">
  <div class="flex items-center justify-center flex-col concept">
    <h2 class="text-2xl sm:text-3xl md:text-header my-8 font-Lato uppercase relative z-20">Comment ça marche?</h2>
  </div>
        ...
        <div class="grid md:grid-cols-6 gap-10">
            <div class="col-span-6 md:col-span-3 lg:col-span-2">
              <div class="flex flex-col items-center">
                  ...
                  <div>
                    <h4 class="font-Lato text-lg font-medium uppercase text-center">Abonnez-vous</h4>
                    <p class="pt-3 text-lg font-cormorant max-w-xs text-justify">Choisissez l'abonnement qui convient le mieux, pour vous faire plaisir chaque mois avec une sélection de produits de beauté</p>
                  </div>
              </div>
            </div>
            <div class="col-span-6 md:col-span-3 lg:col-span-2">
                <div class="flex flex-col items-center">
                    ...
                    <div>
                        <h4 class="font-Lato text-lg font-medium uppercase text-center">Recevez votre box</h4>
                        <p class="pt-3 text-lg font-cormorant max-w-xs text-justify">Recevez votre box remplie de produits de beauté, directement chez vous ou au bureau, au jour et à l'heure qui vous conviennent.</p>
                    </div>
                </div>
            </div>
            <div class="col-span-6 md:col-span-3 lg:col-span-2">
                <div class="flex flex-col items-center">
                    ...
                    <div>
                        <h4 class="font-Lato text-lg font-medium uppercase text-center">Découvrez et partagez</h4>
                        <p class="pt-3 text-lg font-cormorant max-w-xs text-justify">Découvrez les produits choisis pour vous, et partagez votre expérience avec notre communauté.
                            Essayez, évaluez et testez-les.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section id="box" class="py-10">
    ...
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-center flex-col concept">
        <h2 class="text-2xl sm:text-3xl md:text-header my-8 font-Lato uppercase relative z-10">La box du mois</h2>
      </div>
      ...
      <div class=" lg:col-gap-12 xl:col-gap-16 mt-8  grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-6">
        ...
        <div id="boxDescription" class="mt-5 border-t flex flex-col items-center justify-between space-y-4  py-4 sm:flex-row sm:space-y-0">
            {{ $boxMonth->cheap_description }}
        </div>
        <ul id="optionsList"  role="list" class="space-y-4 text-left">
...
{{-- <script>
    ...
    const cheapestButton = document.getElementById('cheapestButton');
    const midPricedButton = document.getElementById('midPricedButton');
    const expensiveButton = document.getElementById('expensiveButton');
    ...
    // Define the data for the different products
    const cheapestProduct = {
        image: '{{ $cheapestBox->image }}',
        title: '{{ $cheapestBox->libelle }}',
        description: '{{ $cheapestBox->description }}',
        price: '{{ $cheapestBox->price }}',
    };
    
    const midPricedProduct = {
        image: '{{ $midPricedBox->image }}',
        title: '{{ $midPricedBox->libelle }}',
        description: '{{ $midPricedBox->description }}',
        price: '{{ $midPricedBox->price }}',
    };
    
    const expensiveProduct = {
        image: '{{ $expensiveBox->image }}',
        title: '{{ $expensiveBox->libelle }}',
        description: '{{ $expensiveBox->description }}',
        price: '{{ $expensiveBox->price }}',
    };
    
    // Function to update the content based on the selected product
    function updateProductContent(product, options) {
    document.querySelector('.main-box-img').src = product.image;
    boxTitle.innerText = product.title;
    boxDescription.innerText = product.description;
    boxPrice.innerText = product.price;
    
    // Update the options list
    const optionsList = document.getElementById('optionsList');
    optionsList.innerHTML = ''; // Clear the existing options
    const myOption = options[0].split(',')
    myOption.forEach(option => {
        const listItem = document.createElement('li');
        listItem.classList.add('flex')
        listItem.classList.add('space-x-3')
    ...
    const cheapestOptions = [
        '{{ implode(",", explode(',', $cheapestBox->options)) }}'
    ];

    const midPricedOptions = [
        '{{ implode(",", explode(',', $midPricedBox->options)) }}'
    ];

    const expensiveOptions = [
        '{{ implode(",", explode(',', $expensiveBox->options)) }}'
    ];
        
    
    // Add click event listeners to the buttons
    cheapestButton.addEventListener('click', function () {
    updateProductContent(cheapestProduct, cheapestOptions);
    this.classList.add('border-gray-900')
    this.classList.remove('border-transparent')
    expensiveButton.classList.add('border-transparent')
    midPricedButton.classList.add('border-transparent')
    });

    midPricedButton.addEventListener('click', function () {
        updateProductContent(midPricedProduct, midPricedOptions);
        this.classList.add('border-gray-900')
        this.classList.remove('border-transparent')
        cheapestButton.classList.add('border-transparent')
        expensiveButton.classList.add('border-transparent')
    });

    expensiveButton.addEventListener('click', function () {
        updateProductContent(expensiveProduct, expensiveOptions);
        this.classList.add('border-gray-900')
        this.classList.remove('border-transparent')
        cheapestButton.classList.add('border-transparent')
        midPricedButton.classList.add('border-transparent')
...
@if(!$products->isEmpty())
<section id="products" class="py-10 bg-background-color ">
  <div class="flex items-center justify-center flex-col concept">
    <h2 class="text-2xl sm:text-3xl md:text-header my-8 font-Lato uppercase relative z-10">Les nouveautés</h2>
  </div>
  <div class="container mx-auto p-6">
    <div class="products  owl-carousel owl-theme">
            ...
            <div class="grid-cols-1 card w-72">
                <div class="card-img relative transition-all h-[300px]">
                    <a href="#">
                    <div class="bg h-full opacity-0 w-full absolute top-0 left-0 transition-all"></div>
                    </a>
                    <a href="#">
                        <img src="{{ $product->photo }}" class="w-full h-full" alt="">
                    </a>
...
@if($boxMonth)
<section id="previous-box" class=" py-10">
    <div class="flex items-center justify-center flex-col concept">
        <h2 class="text-2xl sm:text-3xl md:text-header my-8 font-Lato uppercase relative z-20">Nos box précédentes</h2>
    </div>
    <div class="container mx-auto p-6">
        <div class="grid grid-cols-6 gap-5">
            @forelse ($boxMonths as $box)
                <div class="col-span-6 md:col-span-3 lg:col-span-2">
                    <div>
                        <a href="#">
                            <img src="{{ $box->image }}" class="w-[397px] h-auto" alt="">
                        </a>
                    </div>
                    <p class="pt-5 font-semibold text-black text-center text-lg">{{ \Carbon\Carbon::parse($box->created_at)->format('F Y') }}</p>
                    <p class="py-3  text-black text-center">{{ $box->box_name }}</p>
                </div>
            @empty
            ...
            {{-- <div class="col-span-6 md:col-span-3 lg:col-span-2">
                <div>
                    <a href="#">
                        <img src="{{ asset('images/previous-box-02.webp') }}" alt="">
                    </a>
                </div>
                <p class="pt-5 font-semibold text-black text-center text-lg">NOVEMBRE 2023</p>
                <p class="py-3  text-black text-center">Rock'n'Glam</p>
            </div>
            <div class="col-span-6 md:col-span-3 lg:col-span-2">
                <div>
                    <a href="#">
                        <img src="{{ asset('images/previous-box-3.webp') }}" alt="">
                    </a>
                </div>
                <p class="pt-5 font-semibold text-black text-center text-lg">OCTOBRE 2023</p>
                <p class="py-3  text-black text-center">Written in the Stars</p>
            </div> --}}
        </div>
        <div class="flex justify-center mt-5">
            <a href="#" class="p-2 bg-black text-white hover:scale-110 transition-transform text-center ">VOIR PLUS</a>
        </div>
    </div>
</section>
@endif
...
<section id="blog" class="bg-background-color py-10">
    <div class="flex items-center justify-center flex-col concept py-5">
        <h2 class="text-2xl sm:text-3xl md:text-header my-8 font-Lato uppercase relative z-50">Nos secrets beauté</h2>
    </div>
...
<section id="testimonials" style="background-image: url('images/testi-bg.png');background-position: center;background-size: contain;background-repeat:no-repeat" class="p-24">
  <div class="flex items-center justify-center flex-col concept py-5">
    <h2 class="text-2xl sm:text-xl md:text-header my-8 font-Lato uppercase relative z-50">Expérience de nos abonées</h2>
  </div>
  <div class="container mx-auto p-6">
    <div class="testimonials  owl-carousel owl-theme">
        {{-- <div class="left-scroll mt-24 cursor-pointer">
            ...
            <div class="items-center justify-center flex flex-col">
              <p class="text-center text-[#2d2d2d] max-w-lg italic font-cormorant text-xl">I don't work with a glam squad to get me together for the red carpet, I really enjoy the time it takes to do it myself, to choose my clothes and do my own makeup and my own hair.</p>
              <h4 class="text-center text-[#838383] py-6">Dita Von Teese</h4>
            </div>
            <div class="items-center justify-center flex flex-col">
              <p class="text-center text-[#2d2d2d] max-w-lg italic font-cormorant text-xl">Biagiotti is definitely the place to be when it comes to makeup: You go into the store, and touch it, and try it, and love it. I've never bought anything on the Internet. I like experience </p>
              <h4 class="text-center text-[#838383] py-6">Marc Jacobs</h4>
            </div>
            <div class="items-center justify-center flex flex-col">
              <p class="text-center text-[#2d2d2d] max-w-lg italic font-cormorant text-xl">I would go to cosmetics counters and buy two or three foundations and powders, and then go home and mix them before I came up with something suitable for my undertones.</p>
              <h4 class="text-center text-[#838383] py-6">Iman</h4>
            </div>
...
<section id='company' class="py-10 bg-background-color">
    {{-- <div class="py-8 lg:py-16 mx-auto max-w-screen-xl px-4"> --}}
        {{-- <div class="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6"> --}}
          <div class="flex items-center justify-center flex-col concept py-5">
              <h2 class="text-2xl sm:text-3xl md:text-header my-8 font-Lato uppercase relative z-50">Les marques de nos Box</h2>
          </div>
          <div class="container mx-auto p-6">
            <div class="companies  owl-carousel owl-theme">
...
<section id="social">
    <div class=" px-6 py-10">
      <div class="flex items-center justify-center flex-col concept">
        <h2 class="text-2xl sm:text-3xl md:text-header my-8 font-Lato uppercase relative z-10">REJOIGNEZ-NOUS SUR INSTAGRAM</h2>
    </div>
    </div>
    <div class="flex ">
...
<section id="newsletter-section" class="bg-background-color py-16 ">
    <div class="container mx-auto p-6 flex items-center justify-around">
        <div class="col">
            <h2 class="text-6xl lg:text-large font-tuesday">S'abonner</h2>
        </div>
        <div class="col">
...
<section id="adv">
  <div class="container mx-auto p-6 flex flex-col md:flex-row justify-between items-center gap-10">
    <div class="flex flex-col items-center gap-1">
      ...
      <h5 class="font-Lato text-sm font-light text-center">PAIEMENT SÉCURISÉ</h5>
    </div>
    <div class="flex flex-col items-center gap-1">
      <img src="{{ asset('images/flexible.svg') }}" class="w-[40px] h-[40px]" alt="">
      <h5 class="font-Lato text-sm font-light text-center">ABONNEMENT FLEXIBLE</h5>
    </div>
    <div class="flex flex-col items-center gap-1">
      <img src="{{ asset('images/livraison.svg') }}" class="w-[40px] h-[40px]" alt="">
      <h5 class="font-Lato text-sm font-light text-center">LIVRAISON EXPRESS</h5>
    </div>
    <div class="flex flex-col items-center gap-1">
      <img src="{{ asset('images/chat.svg') }}" class="w-[40px] h-[40px]" alt="">
      <h5 class="font-Lato text-sm font-light text-center">SERVICE CLIENT</h5>
    </div>
    <div class="flex flex-col items-center gap-1">
      <img src="{{ asset('images/verified.svg') }}" class="w-[40px] h-[40px]" alt="">
      <h5 class="font-Lato text-sm font-light text-center">SATISFACTION CLIENT</h5>
    </div>

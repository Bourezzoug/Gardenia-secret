<div id="pop-up" class="fixed w-[650px] h-[400px] bg-white bottom-5 left-10 z-50 pointer-events-none opacity-0 transition-opacity hidden md:block">
    <div class="grid h-full grid-cols-10">
        ...
        <form action="#" class="col-span-6 my-auto mx-auto">
            ...
            <div class="items-center mx-4 space-y-4 max-w-screen-sm sm:flex pt-2 flex-col gap-2 sm:space-y-0">
                <div class="relative w-full">
                    <input class="rounded block p-3 pl-2 w-full text-base text-gray-900 bg-gray-50  border border-gray-300  font-cormorant  outline-none" placeholder="Nom Complet" type="text" id="nom_complet" required>
                </div>
                <div class="relative w-full">
                    <label for="email" class="hidden  text-sm font-medium text-gray-900">Email address</label>
                    <input class="rounded block p-3 pl-2 w-full text-base text-gray-900 bg-gray-50  border border-gray-300  font-cormorant  outline-none" placeholder="Address email" type="email" id="email" required>
                </div>
                <div class="relative w-full">
                    <select name="" id="" class="rounded block p-3 pl-2 w-full text-base text-gray-900 bg-gray-50  border border-gray-300  font-cormorant  outline-none">

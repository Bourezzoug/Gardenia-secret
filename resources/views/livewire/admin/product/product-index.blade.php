                    ...
                    <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                ...
                                >
                                {{ date('jS M Y',strtotime($product->created_at)) }} 
                                </span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <a class="cursor-pointer" wire:click="selectedItem('update',{{ $product->id }})"
                                            class="px-2">
                                    ...
                                    <div class="cursor-pointer" wire:click="selectedItem('show',{{ $product->id }})"
                                            class="px-2">

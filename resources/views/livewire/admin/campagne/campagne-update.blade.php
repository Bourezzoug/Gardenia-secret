            ...
            <x-slot name="content">
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    ...
                    <div class="col-span-1 md:col-span-2 lg:col-span-3">
                        ...
                        <x-input wire:model.defer="date_debut" id="date_debut" type="date" class="mt-1 block w-full" :min="now()->format('Y-m-d')"/>
                        </div>
                    ...
                    <div class="col-span-1 md:col-span-2 lg:col-span-3">
                        ...
                        <x-input wire:model.defer="date_fin" id="date_fin" type="date" class="mt-1 block w-full" disabled/>
                        </div>

        ...
        <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
            ...
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-4 font-medium text-gray-900">Button</th>
            ...
            <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                  <td class="px-6 py-4">
                    <input type="checkbox" wire:model="selectedSliders" value="{{ $slider->id }}" class="bg-neutral-50 border-neutral-200">
                  </td>
                  ...
                  <td class="px-6 py-4">
                    ...
                    >
                    <img src="{{ $slider->image }}" class="w-20 h-20 object-cover" alt="">
                    </span>
                    </div>
                </td>
                  ...
                  <td class="px-6 py-4">
                    <div class="flex gap-2">
                      ...
                      >
                      {{ date('D jS M Y',strtotime($slider->created_at)) }} 
                      </span>
                    </div>
                  </td>
                  <td class="px-6 py-4">
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="cursor-pointer" wire:click="selectedItem('update',{{ $slider->id }})"
                                      class="px-2">
                        ...
                        <div class="cursor-pointer" wire:click="selectedItem('delete',{{ $slider->id }})"
                                      class="px-2">
...
<livewire:admin.home.home-create   />
<livewire:admin.home.home-update   />
<livewire:admin.home.home-delete   />

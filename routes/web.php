...
//     Route::get('/client/quiz',[QuizController::class,'index'])->name('quiz.client.index');
//     Route::post('/client/quiz',[QuizController::class,'store'])->name('quiz.store');
...
Route::middleware(['auth:sanctum', 'verified','authadmin'])->group(function () {
    ...
    Route::get('/admin/home',\App\Http\Livewire\Admin\Home\HomeIndex::class)->name('admin.home.index');
    Route::get('/admin/faq',\App\Http\Livewire\Admin\Faq\FaqIndex::class)->name('admin.faq.index');
});
...
Route::get('la-boxe-du-mois',[BoxController::class,'boxPage'])->name('boxPage.index');

Route::get('/v1',[HomeController::class,'index'])->name('home.test');
Route::post('/v1',[HomeController::class,'store'])->name('email.store');

Route::get('/foo', function () {
    Artisan::call('storage:link');
});
Route::get('/question-answer',[FaqController::class,'index']);